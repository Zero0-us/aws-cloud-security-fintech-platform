# Vuln-bank stg deployment

This stg setup replaces the previous JOA services with Commando-X/vuln-bank.
...
- MFA-required policy: `fin-stg-deny-without-mfa`
- CloudTrail: `fin-stg-cloudtrail`
- Audit log storage: S3 `fin-stg-cloudtrail-364585378962-ap-northeast-2`, CloudWatch Logs `/aws/cloudtrail/fin-stg-cloudtrail`
