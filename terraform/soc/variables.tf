...
variable "log_bucket_suffix" {
  description = "Suffix for log bucket names to ensure global uniqueness"
  type        = string
  sensitive   = false
}

variable "soc_audit_log_bucket_name" {
  description = "SOC audit log archive bucket name prefix"
  type        = string
  default     = "fin-soc-audit-log"
}

variable "soc_compliance_bucket_name" {
  description = "SOC compliance evidence bucket name prefix"
  type        = string
  default     = "fin-soc-compliance"
}

variable "soc_athena_results_bucket_name" {
  description = "SOC Athena query results bucket name prefix"
  type        = string
  default     = "fin-soc-athena-results"
}
