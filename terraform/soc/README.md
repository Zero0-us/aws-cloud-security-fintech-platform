...
각 계정에서 발생하는 감사 로그와 보안 이벤트를 중앙 수집하고, 규제 준수 상태를 점검하며, Athena로 분석할 수 있는 SOC 기반을 준비하는 것이다.
...
SOC는 운영 원본 데이터의 소유자가 아니라 **중앙 로그/감사/관제 허브** 역할을 한다.
